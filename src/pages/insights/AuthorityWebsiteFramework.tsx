...
export default function AuthorityWebsiteFramework() {
  return (
    <>
      <Helmet>
        <title>
          The Authority Website Framework | Building Trust Through Structure | Perceptra
        </title>
        <meta
          name="description"
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id":
                "https://www.perceptra.in/insights/authority-website-framework"
            }
          })}
        </script>
      </Helmet>
          ...
          <article className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <h2 className="text-3xl font-bold text-white mt-12 mb-6">
                Foundation Layer Trust Signals
              </h2>
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                Authority websites guide visitors through intentional pathways. From awareness to consideration to decision, each step is designed to reduce friction and build trust.
              </p>
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                Speed, security, and mobile optimization are not optional. These technical factors directly impact how prospects perceive your authority.
              </p>
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                When these elements work together, your website becomes a 24/7 authority building machine.
              </p>
            </div>
